            ...
            <div class="profile-header">
              ...
              <div class="profile-header-content">
                ...
                <div class="profile-header-info">
                  ...
                  <a class="btn btn-sm btn-info mb-2"><router-link :to="`/edit-profile/${userStore.user.id}`">Edit Profile</router-link></a>
                  <br>
                  <a href="#" class="btn btn-sm btn-info mb-2"><router-link :to="`/edit-password/${userStore.user.id}`">Edit Password</router-link></a>
                </div>
              ...
              <ul class="profile-header-tab nav nav-tabs">
                <li class="nav-item"><a href="https://www.bootdey.com/snippets/view/bs4-profile-with-timeline-posts"
                                        target="__blank" class="nav-link_">OFFERS</a></li>
                ...
                <li class="nav-item"><a href="https://www.bootdey.com/snippets/view/bs4-profile-friend-list"
                                        target="__blank" class="nav-link_ active show">REVIEWS</a></li>
              </ul>
                    ...
                    <div class="timeline-body">
                      <div class="timeline-content">
                        <div v-for="product in products" :key="product.id">
                          ...
                          <product-card :product="product" @click="goToProductDetail(product.id)"/>

                          <div class="timeline-footer">
                            <a href="javascript:;" class="m-r-15 text-inverse-lighter">
                              <i class="fa fa-thumbs-up fa-fw fa-lg m-r-3"></i> Add to favorite
                            </a>
                            <br>
                          </div>
                        </div>
